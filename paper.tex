...
\begin{figure}
\begin{subfigure}{.5\textwidth}
\includegraphics[scale=.125]{bias_by_timezero.png}
\subcaption{Bias of MechBayes and COVID-Baseline as a function of time. }
\end{subfigure}%
\begin{subfigure}{.5\textwidth}
\includegraphics[scale=.125]{ablation_calibration.png}
